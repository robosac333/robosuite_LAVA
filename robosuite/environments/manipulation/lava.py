...
class LAVA(SingleArmEnv):
    ...
    def __init__(
        ...
        self.placement_initializer_food = None
    ...
    def _load_model(self):
        ...
        if self.placement_initializer is not None:
            ...
            self.placement_initializer.add_objects(self.bowl)
            # for food in food_objects:
            #     self.placement_initializer.add_objects(food)
        else:
        ...
        #     bowl_body.set("pos", "0 0 0.05")  # Set bowl position, adjust as necessary
    ...
    def _setup_references(self):
        ...
        self.cube_body_id = self.sim.model.body_name2id(self.bowl.root_body)
    ...
    def visualize(self, vis_settings):
        ...
        if vis_settings["grippers"]:
            self._visualize_gripper_to_target(gripper=self.robots[0].gripper, target=self.bowl)
